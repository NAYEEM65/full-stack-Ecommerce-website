        ...
        <section>
            {/* <div>
                ...
                <div>
                    ...
                    <div className="">
                        <Card cardclassName="p-8 bg-blue-400 text-white">
                            <h3 className="text-white">Our Contact Information</h3>
                            ...
                            <div className="my-12 mx-0">
                                <span className="flex justify-start items-center mb-4">
                                    <FaPhoneAlt />
                                    <p className="ml-1">+880 1775225448</p>
                                </span>
                                <span className="flex justify-start items-center mb-4">
                                    <FaEnvelope />
                                    <p className="ml-1">Support@nsshop.com</p>
                                </span>
                                <span className="flex justify-start items-center mb-4">
                                    <GoLocation />
                                    <p className="ml-1">GopalGanj Dhaka</p>
                                </span>
                                <span className="flex justify-start items-center mb-4">
                                    <FaTwitter />
                        ...
                        <div className="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
                            <form ref={form} onSubmit={sendEmail}>
                                <div className="form-group mb-6">
                                    <input
                                        type="text"
                                        className="w-full form-control block w-ful px-3 py-1.5text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out  m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        name="user_name"
